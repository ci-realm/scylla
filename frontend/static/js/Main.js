...
var author$project$Command$wsConnect = function (url) {
	return author$project$WebSocket$open(url);
};
...
var author$project$Init$buildId_ = A2(elm$url$Url$Parser$custom, 'BUILD_ID', elm$core$String$toInt);
var author$project$Msgs$BuildRoute = function (a) {
	return {$: 'BuildRoute', a: a};
};
var author$project$Msgs$BuildsRoute = {$: 'BuildsRoute'};
var author$project$Msgs$HomeRoute = {$: 'HomeRoute'};
var author$project$Msgs$OrganizationBuildsRoute = function (a) {
	return {$: 'OrganizationBuildsRoute', a: a};
};
var author$project$Msgs$OrganizationsRoute = {$: 'OrganizationsRoute'};
...
var author$project$Init$routes = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, author$project$Msgs$HomeRoute, elm$url$Url$Parser$top),
			A2(
			elm$url$Url$Parser$map,
			author$project$Msgs$BuildsRoute,
			elm$url$Url$Parser$s('builds')),
			A2(
			elm$url$Url$Parser$map,
			author$project$Msgs$BuildRoute,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('build'),
				author$project$Init$buildId_)),
			A2(
			elm$url$Url$Parser$map,
			author$project$Msgs$OrganizationsRoute,
			elm$url$Url$Parser$s('organizations')),
			A2(
			elm$url$Url$Parser$map,
			author$project$Msgs$OrganizationBuildsRoute,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('organizations'),
				elm$url$Url$Parser$string))
		]));
var author$project$Msgs$NotFoundRoute = {$: 'NotFoundRoute'};
...
var author$project$Init$routeFor = function (url) {
	return A2(
		elm$core$Maybe$withDefault,
		author$project$Msgs$NotFoundRoute,
		A2(elm$url$Url$Parser$parse, author$project$Init$routes, url));
};
...
var author$project$Init$init = F3(
	function (_n0, url, key) {
		return _Utils_Tuple2(
			{
				build: elm$core$Maybe$Nothing,
				buildLogPaused: false,
				error: elm$core$Maybe$Nothing,
				key: key,
				lastBuilds: _List_Nil,
				organizationBuilds: _List_Nil,
				organizations: _List_Nil,
				route: author$project$Init$routeFor(url),
				socket: elm$core$Maybe$Nothing,
				socketDebounce: jinjor$elm_debounce$Debounce$init,
			...
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2(elm$core$Task$perform, author$project$Msgs$Tick, elm$time$Time$now),
						author$project$Command$wsConnect('ws://localhost:7100/socket')
					])));
	});
var author$project$Msgs$SocketReceived = function (a) {
	return {$: 'SocketReceived', a: a};
};
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$WebSocket$closeFD = _Platform_incomingPort('closeFD', elm$json$Json$Decode$value);
var author$project$WebSocket$newFD = _Platform_incomingPort('newFD', elm$json$Json$Decode$value);
var author$project$Msgs$SocketClosed = function (a) {
	return {$: 'SocketClosed', a: a};
};
var author$project$Msgs$SocketNotOpened = {$: 'SocketNotOpened'};
...
var author$project$Data$Socket = F2(
	function (url, fd) {
...
var author$project$WebSocket$decodeSocket = elm$json$Json$Decode$decodeValue(
	A3(
		...
		A3(
			...
			elm$json$Json$Decode$succeed(author$project$Data$Socket))));
var author$project$WebSocket$processCloseFD = function (value) {
	var _n0 = author$project$WebSocket$decodeSocket(value);
	if (_n0.$ === 'Ok') {
		var socket = _n0.a;
		return author$project$Msgs$SocketClosed(socket);
	} else {
		return author$project$Msgs$SocketNotOpened;
	}
};
var author$project$Msgs$SocketOpened = function (a) {
	return {$: 'SocketOpened', a: a};
};
var author$project$WebSocket$processNewFD = function (value) {
	var _n0 = author$project$WebSocket$decodeSocket(value);
	if (_n0.$ === 'Ok') {
		var socket = _n0.a;
		return author$project$Msgs$SocketOpened(socket);
	} else {
		return author$project$Msgs$SocketNotOpened;
	}
};
...
var author$project$WebSocket$subscriptions = elm$core$Platform$Sub$batch(
	_List_fromArray(
		[
			author$project$WebSocket$newFD(author$project$WebSocket$processNewFD),
			author$project$WebSocket$closeFD(author$project$WebSocket$processCloseFD),
			author$project$WebSocket$recv(author$project$Msgs$SocketReceived)
		]));
...
var author$project$Main$subscriptions = function (_n0) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$WebSocket$subscriptions,
				A2(elm$time$Time$every, 60000, author$project$Msgs$Tick)
			]));
};
...
var author$project$Command$send = F2(
	function (ms, v) {
		if (ms.$ === 'Nothing') {
...
var author$project$Command$sendKind = F3(
	function (socket, kind, data) {
		return A2(
			author$project$Command$send,
			socket,
...
var author$project$Command$buildLogUnwatch = F2(
	function (socket, id) {
		return A3(
			author$project$Command$sendKind,
			socket,
			'buildLogUnwatch',
			_List_fromArray(
				[
...
var author$project$Command$buildLogWatch = F2(
	function (socket, id) {
		return A3(
			author$project$Command$sendKind,
			socket,
...
var author$project$Command$buildRestart = F2(
	function (socket, id) {
		return A3(
			author$project$Command$sendKind,
			socket,
...
var author$project$Command$getLastBuilds = function (socket) {
	return A3(author$project$Command$sendKind, socket, 'lastBuilds', _List_Nil);
};
var author$project$Command$getOrganizationBuilds = F2(
...
var author$project$Command$getOrganizations = function (socket) {
	return A3(author$project$Command$sendKind, socket, 'organizations', _List_Nil);
};
...
var author$project$Data$Build = function (id) {
	return function (status) {
		return function (createdAt) {
			return function (finishedAt) {
				return function (owner) {
					return function (ownerLink) {
						return function (repo) {
							return function (repoLink) {
								return function (sha) {
									return function (prNumber) {
										return function (prTitle) {
											return function (branch) {
												return function (userLogin) {
													return function (log) {
														return {branch: branch, createdAt: createdAt, finishedAt: finishedAt, id: id, log: log, owner: owner, ownerLink: ownerLink, prNumber: prNumber, prTitle: prTitle, repo: repo, repoLink: repoLink, sha: sha, status: status, userLogin: userLogin};
													};
												};
											};
										};
...
var author$project$Data$LogLine = F3(
	function (buildId, createdAt, line) {
		return {buildId: buildId, createdAt: createdAt, line: line};
	});
...
var author$project$Github$decodeTime = A2(
	elm$json$Json$Decode$andThen,
	function (iso) {
		return elm$json$Json$Decode$succeed(
			function () {
				var _n0 = rtfeldman$elm_iso8601_date_strings$Iso8601$toTime(iso);
				if (_n0.$ === 'Ok') {
					var time = _n0.a;
					return time;
				} else {
	...
	elm$json$Json$Decode$string);
var author$project$Github$decodeLogLine = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'line',
	elm$json$Json$Decode$string,
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'createdAt',
		author$project$Github$decodeTime,
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'buildId',
			elm$json$Json$Decode$int,
			elm$json$Json$Decode$succeed(author$project$Data$LogLine))));
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Github$decodeBuild = A4(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
	'log',
	elm$json$Json$Decode$list(author$project$Github$decodeLogLine),
	_List_Nil,
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$requiredAt,
		_List_fromArray(
			['hook', 'pull_request', 'user', 'login']),
		elm$json$Json$Decode$string,
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$requiredAt,
			_List_fromArray(
				['hook', 'pull_request', 'base', 'ref']),
			elm$json$Json$Decode$string,
			A3(
				NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$requiredAt,
				_List_fromArray(
					['hook', 'pull_request', 'title']),
				elm$json$Json$Decode$string,
				A3(
					NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$requiredAt,
					_List_fromArray(
						['hook', 'pull_request', 'number']),
					elm$json$Json$Decode$int,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$requiredAt,
						_List_fromArray(
							['hook', 'pull_request', 'head', 'sha']),
						elm$json$Json$Decode$string,
						A3(
							NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$requiredAt,
							_List_fromArray(
								['hook', 'pull_request', 'head', 'repo', 'html_url']),
							elm$json$Json$Decode$string,
							A3(
								NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$requiredAt,
								_List_fromArray(
									['hook', 'pull_request', 'head', 'repo', 'name']),
								elm$json$Json$Decode$string,
								A3(
									NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$requiredAt,
									_List_fromArray(
										['hook', 'pull_request', 'head', 'repo', 'owner', 'html_url']),
									elm$json$Json$Decode$string,
									A3(
										NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$requiredAt,
										_List_fromArray(
											['hook', 'pull_request', 'head', 'repo', 'owner', 'login']),
										elm$json$Json$Decode$string,
										A3(
											NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
											'finishedAt',
											...
											A3(
												...
												A3(
													...
													A3(
														...
														'id',
														elm$json$Json$Decode$int,
														elm$json$Json$Decode$succeed(author$project$Data$Build)))))))))))))));
var author$project$Data$Organization = F3(
	function (owner, url, buildCount) {
		return {buildCount: buildCount, owner: owner, url: url};
	});
var author$project$Github$decodeOrganization = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'buildCount',
	elm$json$Json$Decode$int,
	A3(
		...
		A3(
			...
			'owner',
			elm$json$Json$Decode$string,
			elm$json$Json$Decode$succeed(author$project$Data$Organization))));
var elm$json$Json$Decode$map = _Json_map1;
var author$project$Github$mapData = F3(
	function (key, t, decoder) {
		return A2(
...
var author$project$Msgs$MutateBuild = function (a) {
	return {$: 'MutateBuild', a: a};
};
var author$project$Msgs$MutateLastBuilds = function (a) {
	return {$: 'MutateLastBuilds', a: a};
};
var author$project$Msgs$MutateLogLine = function (a) {
	return {$: 'MutateLogLine', a: a};
};
var author$project$Msgs$MutateOrganizationBuilds = function (a) {
	return {$: 'MutateOrganizationBuilds', a: a};
};
var author$project$Msgs$MutateOrganizations = function (a) {
	return {$: 'MutateOrganizations', a: a};
};
var author$project$Msgs$MutateRestart = {$: 'MutateRestart'};
var author$project$Github$payloadDecode = function (mutation) {
	switch (mutation) {
		case 'lastBuilds':
			return A3(
				author$project$Github$mapData,
				'builds',
				author$project$Msgs$MutateLastBuilds,
				elm$json$Json$Decode$list(author$project$Github$decodeBuild));
		case 'build':
			return A3(author$project$Github$mapData, 'build', author$project$Msgs$MutateBuild, author$project$Github$decodeBuild);
		case 'organizations':
			return A3(
				author$project$Github$mapData,
				'organizations',
				author$project$Msgs$MutateOrganizations,
				elm$json$Json$Decode$list(author$project$Github$decodeOrganization));
		case 'organizationBuilds':
			return A3(
				author$project$Github$mapData,
				'organizationBuilds',
				author$project$Msgs$MutateOrganizationBuilds,
				elm$json$Json$Decode$list(author$project$Github$decodeBuild));
		case 'buildLog':
			return A2(
				elm$json$Json$Decode$map,
				author$project$Msgs$MutateLogLine,
				A2(
					elm$json$Json$Decode$at,
					_List_fromArray(
						['data', 'data']),
					author$project$Github$decodeLogLine));
		case 'restart':
			return elm$json$Json$Decode$succeed(author$project$Msgs$MutateRestart);
		default:
			return elm$json$Json$Decode$fail('Invalid mutation type: ' + mutation);
	}
};
var author$project$Github$payloadDecoder = A2(
	elm$json$Json$Decode$andThen,
	author$project$Github$payloadDecode,
	A2(
		elm$json$Json$Decode$at,
		_List_fromArray(
			['data', 'mutation']),
...
var author$project$Command$getBuild = F2(
	function (socket, id) {
		return A3(
			author$project$Command$sendKind,
			socket,
...
var author$project$Init$urlChanged = function (model) {
	var route = author$project$Init$routeFor(model.url);
	var updatedModel = _Utils_update(
		model,
		{route: route});
	switch (route.$) {
		case 'HomeRoute':
			return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(updatedModel);
		case 'BuildsRoute':
			return A2(
				Janiczek$cmd_extra$Cmd$Extra$withCmd,
				author$project$Command$getLastBuilds(model.socket),
				updatedModel);
		case 'BuildRoute':
			var id = route.a;
			return A2(
				...
				_List_fromArray(
					[
						A2(author$project$Command$getBuild, model.socket, id),
						A2(author$project$Command$buildLogWatch, model.socket, id)
					]),
				updatedModel);
		case 'OrganizationsRoute':
			return A2(
				Janiczek$cmd_extra$Cmd$Extra$withCmd,
				author$project$Command$getOrganizations(model.socket),
				updatedModel);
		case 'OrganizationBuildsRoute':
			var name = route.a;
			return A2(
				Janiczek$cmd_extra$Cmd$Extra$withCmd,
				A2(author$project$Command$getOrganizationBuilds, model.socket, name),
				updatedModel);
		default:
			return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(updatedModel);
	}
};
var author$project$Update$appendLog = F2(
	function (model, line) {
		var _n0 = model.build;
		if (_n0.$ === 'Just') {
			var build = _n0.a;
...
var author$project$Msgs$SocketDebounce = function (a) {
	return {$: 'SocketDebounce', a: a};
};
...
var author$project$Update$debounceConfig = {
	strategy: jinjor$elm_debounce$Debounce$later(10000),
	transform: author$project$Msgs$SocketDebounce
};
var author$project$Utils$scrollIntoView = _Platform_outgoingPort('scrollIntoView', elm$json$Json$Encode$string);
...
var author$project$Update$update = F2(
	function (message, model) {
		switch (message.$) {
			...
			case 'UrlChanged':
				var url = message.a;
				return author$project$Init$urlChanged(
					_Utils_update(
						model,
						{url: url}));
			case 'SocketDebounce':
				...
				var _n2 = A4(
					...
					jinjor$elm_debounce$Debounce$takeLast(author$project$Command$wsConnect),
					msg_,
					model.socketDebounce);
				var debounce = _n2.a;
				var cmd = _n2.b;
				return A2(
					Janiczek$cmd_extra$Cmd$Extra$withCmd,
			...
			case 'SocketClosed':
				var oldSocket = message.a;
				var _n3 = A3(jinjor$elm_debounce$Debounce$push, author$project$Update$debounceConfig, oldSocket.url, model.socketDebounce);
				var debounce = _n3.a;
				var cmd = _n3.b;
				return A2(
					Janiczek$cmd_extra$Cmd$Extra$withCmd,
			...
			case 'SocketReceived':
				var value = message.a;
				var _n4 = A2(elm$json$Json$Decode$decodeValue, author$project$Github$payloadDecoder, value);
				if (_n4.$ === 'Ok') {
					var decoded = _n4.a;
					switch (decoded.$) {
						case 'MutateLastBuilds':
							var obj = decoded.a;
							return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
								_Utils_update(
									model,
						...
						case 'MutateBuild':
							...
							return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
								_Utils_update(
									model,
									{
										build: elm$core$Maybe$Just(obj)
									}));
						case 'MutateOrganizations':
							var obj = decoded.a;
							return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
								_Utils_update(
									model,
									{organizations: obj}));
						case 'MutateOrganizationBuilds':
							var obj = decoded.a;
							return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
								_Utils_update(
									model,
									{organizationBuilds: obj}));
						default:
							var obj = decoded.a;
							return A2(
								Janiczek$cmd_extra$Cmd$Extra$withCmd,
								author$project$Utils$scrollIntoView('last-log-line'),
								A2(author$project$Update$appendLog, model, obj));
					}
				} else {
					var error = _n4.a;
					return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
			...
			case 'BuildLogUnwatch':
				...
				return A2(
					Janiczek$cmd_extra$Cmd$Extra$withCmd,
					A2(author$project$Command$buildLogUnwatch, model.socket, id),
					_Utils_update(
						model,
						{buildLogPaused: true}));
			default:
				...
				return A2(
					Janiczek$cmd_extra$Cmd$Extra$withCmd,
					A2(author$project$Command$buildRestart, model.socket, id),
					model);
		}
	});
var author$project$Init$urlFor = function (route) {
	switch (route.$) {
		case 'HomeRoute':
			return '/';
		case 'BuildsRoute':
		...
		case 'BuildRoute':
			var id = route.a;
			return '/build/' + elm$core$String$fromInt(id);
		case 'OrganizationsRoute':
...
var author$project$Page$Build$formatTime = F2(
	function (buildStart, logTime) {
		var diff = elm$time$Time$millisToPosix(
			elm$time$Time$posixToMillis(logTime) - elm$time$Time$posixToMillis(buildStart));
		var hours = A2(elm$time$Time$toHour, elm$time$Time$utc, diff);
		var minutes = A2(elm$time$Time$toMinute, elm$time$Time$utc, diff);
		var seconds = A2(elm$time$Time$toSecond, elm$time$Time$utc, diff);
		return A2(
			elm$core$String$join,
			':',
			A2(
...
var author$project$Msgs$BuildLogUnwatch = function (a) {
	return {$: 'BuildLogUnwatch', a: a};
};
var author$project$Msgs$BuildLogWatch = function (a) {
	return {$: 'BuildLogWatch', a: a};
};
...
var author$project$Style$blue = A3(mdgriffith$elm_ui$Element$rgb, 0.13, 0.58, 0.95);
var author$project$Style$white = A3(mdgriffith$elm_ui$Element$rgb, 1, 1, 1);
...
var author$project$Style$styledButton = mdgriffith$elm_ui$Element$Input$button(
	_List_fromArray(
		[
			...
			mdgriffith$elm_ui$Element$Background$color(author$project$Style$blue)
		]));
...
var author$project$Page$Build$pauseButton = F2(
	function (paused, id) {
		return paused ? author$project$Style$styledButton(
			{
				label: mdgriffith$elm_ui$Element$text('Continue'),
				onPress: elm$core$Maybe$Just(
					author$project$Msgs$BuildLogWatch(id))
			}) : author$project$Style$styledButton(
			{
				label: mdgriffith$elm_ui$Element$text('Pause'),
				onPress: elm$core$Maybe$Just(
					author$project$Msgs$BuildLogUnwatch(id))
			});
	});
var author$project$Msgs$BuildRestart = function (a) {
	return {$: 'BuildRestart', a: a};
};
var author$project$Page$Build$restartButton = function (id) {
	return author$project$Style$styledButton(
		{
			label: mdgriffith$elm_ui$Element$text('Restart this build'),
			onPress: elm$core$Maybe$Just(
				author$project$Msgs$BuildRestart(id))
		});
};
...
var author$project$Page$Build$viewLogLine = F3(
	function (lastLogLine, timeFormat, line) {
		var additional = lastLogLine ? _List_fromArray(
			[
				mdgriffith$elm_ui$Element$htmlAttribute(
				elm$html$Html$Attributes$id('last-log-line'))
			]) : _List_Nil;
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text(line.line)
						]))
				]));
	});
var author$project$Page$Build$viewLogLines = F2(
	function (timeFormat, lines) {
		var listLength = elm$core$List$length(lines) - 1;
		return A2(
			elm$core$List$indexedMap,
			F2(
				function (idx, line) {
					return A3(
						author$project$Page$Build$viewLogLine,
						_Utils_eq(idx, listLength),
						timeFormat,
						line);
				}),
			lines);
...
var author$project$Style$fontSize = function (n) {
	return mdgriffith$elm_ui$Element$Font$size(
		elm$core$Basics$round(
			A3(mdgriffith$elm_ui$Element$modular, 16, 1.25, n)));
};
var author$project$Style$lightBlue = A3(mdgriffith$elm_ui$Element$rgb, 0.69, 0.87, 0.85);
...
var author$project$Style$styledLink = mdgriffith$elm_ui$Element$link(
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$Font$color(author$project$Style$lightBlue)
		]));
...
var gingko$time_distance$Time$Distance$inWordsWithConfig = F4(
	function (config, locale, otherTime, currentTime) {
		...
		var tense = function () {
			var _n0 = A2(elm$core$Basics$compare, currentSeconds, otherSeconds);
			if (_n0.$ === 'GT') {
...
var gingko$time_distance$Time$Distance$I18n$en = F3(
	function (_n0, tense, distanceId) {
		var withAffix = _n0.withAffix;
		var toStr = elm$core$String$fromInt;
		var maybeAffix = function (str) {
			var _n2 = _Utils_Tuple2(withAffix, tense);
			if (_n2.a) {
				if (_n2.b.$ === 'Past') {
					var _n3 = _n2.b;
					return str + ' ago';
...
var author$project$Utils$timeDistanceWithAffix = F2(
...
var author$project$Utils$timeDistanceWithoutAffix = F2(
	function (fromTime, toTime) {
		return A4(
			gingko$time_distance$Time$Distance$inWordsWithConfig,
			{withAffix: false},
...
var author$project$Page$Build$viewBuild = F2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$Style$fontSize(4),
								mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
							]),
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										author$project$Style$styledLink(
										{
											label: mdgriffith$elm_ui$Element$text(build.owner),
											url: build.ownerLink
										}),
										mdgriffith$elm_ui$Element$text(' / '),
										author$project$Style$styledLink(
										{
											label: mdgriffith$elm_ui$Element$text(build.repo),
											url: build.repoLink
										}),
										mdgriffith$elm_ui$Element$text(' Build '),
										author$project$Style$styledLink(
										{
											label: mdgriffith$elm_ui$Element$text(
												'#' + elm$core$String$fromInt(build.id)),
											url: author$project$Init$urlFor(
												author$project$Msgs$BuildRoute(build.id))
										})
									]))
							]))
					])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text(
								'Pull Request ' + elm$core$String$fromInt(build.prNumber)),
								mdgriffith$elm_ui$Element$text(build.prTitle)
							]))
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text('Commit ' + build.sha)
							]))
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text('Branch ' + build.branch)
							]))
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text(build.userLogin)
							]))
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text(
								'Finished in ' + A2(author$project$Utils$timeDistanceWithoutAffix, build.createdAt, build.finishedAt))
							]))
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text(
								'Started build ' + A2(author$project$Utils$timeDistanceWithAffix, model.time, build.createdAt))
							]))
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2(author$project$Page$Build$pauseButton, model.buildLogPaused, build.id)
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						_List_Nil,
						_List_fromArray(
							[
								author$project$Page$Build$restartButton(build.id)
							]))
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						A2(
							author$project$Page$Build$viewLogLines,
							author$project$Page$Build$formatTime(build.createdAt),
							build.log))
					]))
			]);
	});
var author$project$Page$Build$view = function (model) {
	var _n0 = model.build;
	if (_n0.$ === 'Nothing') {
		return A2(
			mdgriffith$elm_ui$Element$column,
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('Build not found')
				]));
	} else {
		var build = _n0.a;
		return A2(
			...
			A2(author$project$Page$Build$viewBuild, model, build));
	}
};
var author$project$Msgs$GetLastBuilds = {$: 'GetLastBuilds'};
var icidasset$elm_material_icons$Material$Icons$Inherit = {$: 'Inherit'};
...
var author$project$Style$iconButton = F3(
	function (icon, label, onPress) {
		return author$project$Style$styledButton(
			{
				label: A2(
					mdgriffith$elm_ui$Element$row,
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$html(
								A2(icon, 20, icidasset$elm_material_icons$Material$Icons$Inherit))),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_Nil,
...
var author$project$Style$lightGrey = A3(mdgriffith$elm_ui$Element$rgb, 0.25, 0.25, 0.25);
var author$project$Widget$BuildsTable$recentBuildsBuildColumn = function (build) {
	return author$project$Style$styledLink(
		{
			label: mdgriffith$elm_ui$Element$text(
				elm$core$String$fromInt(build.id)),
			url: author$project$Init$urlFor(
...
var author$project$Widget$BuildsTable$recentBuildsDurationColumn = function (build) {
	return _Utils_eq(
		-62135596800000,
		elm$time$Time$posixToMillis(build.finishedAt)) ? mdgriffith$elm_ui$Element$text('pending') : mdgriffith$elm_ui$Element$text(
		A2(author$project$Utils$timeDistanceWithoutAffix, build.createdAt, build.finishedAt));
};
var author$project$Widget$BuildsTable$recentBuildsProjectColumn = function (build) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_Nil,
		_List_fromArray(
...
var author$project$Widget$BuildsTable$shortSHA = A2(elm$core$String$slice, 0, 7);
var author$project$Widget$BuildsTable$recentBuildsSHAColumn = function (build) {
	var shaLink = build.repoLink + ('/commit/' + build.sha);
	return author$project$Style$styledLink(
		{
			label: mdgriffith$elm_ui$Element$text(
				author$project$Widget$BuildsTable$shortSHA(build.sha)),
			url: shaLink
		});
};
var author$project$Widget$BuildsTable$recentBuildsStartedAtColumn = F2(
	function (model, build) {
		return mdgriffith$elm_ui$Element$text(
			A2(author$project$Utils$timeDistanceWithAffix, model.time, build.createdAt));
	});
...
var author$project$Widget$BuildsTable$view = function (model) {
	return A2(
			...
			]),
		{
			columns: _List_fromArray(
				[
					...
					view: author$project$Widget$BuildsTable$recentBuildsBuildColumn,
					...
					view: author$project$Widget$BuildsTable$recentBuildsProjectColumn,
					width: mdgriffith$elm_ui$Element$fill
				},
					{
					header: mdgriffith$elm_ui$Element$text('SHA'),
					view: author$project$Widget$BuildsTable$recentBuildsSHAColumn,
					width: mdgriffith$elm_ui$Element$fill
				},
					{
					header: mdgriffith$elm_ui$Element$text('Started'),
					view: author$project$Widget$BuildsTable$recentBuildsStartedAtColumn(model),
					width: mdgriffith$elm_ui$Element$fill
				},
					{
					header: mdgriffith$elm_ui$Element$text('Duration'),
					view: author$project$Widget$BuildsTable$recentBuildsDurationColumn,
					width: mdgriffith$elm_ui$Element$fill
				}
				]),
			data: model.builds
...
var icidasset$elm_material_icons$Material$Icons$Av$replay = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$d('M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8z')
				]),
			_List_Nil)
		]));
var mdgriffith$elm_ui$Internal$Model$Right = {$: 'Right'};
var mdgriffith$elm_ui$Element$alignRight = mdgriffith$elm_ui$Internal$Model$AlignX(mdgriffith$elm_ui$Internal$Model$Right);
var author$project$Page$Builds$view = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$Widget$BuildsTable$view(
								{builds: model.lastBuilds, time: model.time})
							]))
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A3(
								author$project$Style$iconButton,
								icidasset$elm_material_icons$Material$Icons$Av$replay,
								'Refresh',
								elm$core$Maybe$Just(author$project$Msgs$GetLastBuilds))
							]))
					]))
			]));
};
var author$project$Msgs$GetOrganizationBuilds = function (a) {
	return {$: 'GetOrganizationBuilds', a: a};
};
var author$project$Page$OrganizationBuilds$view = F2(
	function (model, name) {
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									author$project$Widget$BuildsTable$view(
									{builds: model.organizationBuilds, time: model.time})
								]))
						])),
					A2(
					mdgriffith$elm_ui$Element$row,
						...
						[
							...
							_List_fromArray(
								[
									...
									'Refresh',
									elm$core$Maybe$Just(
										author$project$Msgs$GetOrganizationBuilds(name)))
								]))
						]))
				]));
	});
var author$project$Msgs$GetOrganizations = {$: 'GetOrganizations'};
var author$project$Page$Organizations$orgBuildCount = function (org) {
	return mdgriffith$elm_ui$Element$text(
		elm$core$String$fromInt(org.buildCount));
};
var author$project$Page$Organizations$orgName = function (org) {
	return author$project$Style$styledLink(
		{
			label: mdgriffith$elm_ui$Element$text(org.owner),
			url: author$project$Init$urlFor(
				author$project$Msgs$OrganizationBuildsRoute(org.owner))
		});
};
var author$project$Page$Organizations$orgURL = function (org) {
	return mdgriffith$elm_ui$Element$text(org.url);
};
var author$project$Page$Organizations$recentBuilds = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$table,
		_List_fromArray(
			[
			...
			]),
		{
			columns: _List_fromArray(
				[
					...
					view: author$project$Page$Organizations$orgName,
					width: mdgriffith$elm_ui$Element$fill
				},
					{
					header: mdgriffith$elm_ui$Element$text('URL'),
					view: author$project$Page$Organizations$orgURL,
					width: mdgriffith$elm_ui$Element$fill
				},
					{
					header: mdgriffith$elm_ui$Element$text('Builds'),
					view: author$project$Page$Organizations$orgBuildCount,
					width: mdgriffith$elm_ui$Element$fill
				}
				]),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$Page$Organizations$recentBuilds(model)
							]))
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
					...
					[
						...
						_List_fromArray(
							[
								...
								icidasset$elm_material_icons$Material$Icons$Av$replay,
								'Refresh',
								elm$core$Maybe$Just(author$project$Msgs$GetOrganizations))
							]))
					]))
			]));
};
var author$project$Style$grey = A3(mdgriffith$elm_ui$Element$rgb, 0.18, 0.18, 0.18);
var author$project$View$mapNavItem = function (_n0) {
	var title = _n0.a;
	var link = _n0.b;
	return A2(
		mdgriffith$elm_ui$Element$column,
...
var author$project$View$titleFor = function (route) {
	switch (route.$) {
		case 'HomeRoute':
			return 'Home';
		case 'BuildRoute':
		...
		case 'OrganizationBuildsRoute':
			var name = route.a;
			return 'Recent Builds for ' + name;
		default:
			return 'Not Found';
	}
};
var author$project$View$navItems = A2(
	elm$core$List$map,
	function (r) {
		return _Utils_Tuple2(
			author$project$View$titleFor(r),
			author$project$Init$urlFor(r));
	},
	_List_fromArray(
		[author$project$Msgs$HomeRoute, author$project$Msgs$BuildsRoute, author$project$Msgs$OrganizationsRoute]));
...
var author$project$View$skeleton = F3(
	function (model, title, kids) {
		return {
				...
				[
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$Background$color(author$project$Style$grey),
							mdgriffith$elm_ui$Element$Font$color(author$project$Style$white),
							mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
						]),
					A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												A2(elm$core$List$map, author$project$View$mapNavItem, author$project$View$navItems))
											]))
									])),
								A2(
								mdgriffith$elm_ui$Element$row,
...
var author$project$View$view = function (model) {
	var title = author$project$View$titleFor(model.route);
	var show = A2(author$project$View$skeleton, model, title);
	var _n0 = model.route;
	switch (_n0.$) {
		case 'NotFoundRoute':
			return show(
		...
		case 'BuildsRoute':
			return show(
				_List_fromArray(
					[
						author$project$Page$Builds$view(model)
					]));
		case 'BuildRoute':
			return show(
				_List_fromArray(
					[
						author$project$Page$Build$view(model)
					]));
		case 'OrganizationsRoute':
			return show(
				_List_fromArray(
					[
						author$project$Page$Organizations$view(model)
					]));
		case 'OrganizationBuildsRoute':
			var name = _n0.a;
			return show(
				_List_fromArray(
					[
						A2(author$project$Page$OrganizationBuilds$view, model, name)
					]));
		default:
			return show(
				_List_fromArray(
...
var author$project$Main$main = elm$browser$Browser$application(
	{init: author$project$Init$init, onUrlChange: author$project$Msgs$UrlChanged, onUrlRequest: author$project$Msgs$LinkClicked, subscriptions: author$project$Main$subscriptions, update: author$project$Update$update, view: author$project$View$view});
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Msgs.Msg","aliases":{"Data.Socket":{"args":[],"type":"{ url : String.String, fd : Basics.Int }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Msgs.Msg":{"args":[],"tags":{"SocketOpened":["Data.Socket"],"SocketClosed":["Data.Socket"],"SocketNotOpened":[],"SocketReceived":["Json.Encode.Value"],"SocketDebounce":["Debounce.Msg"],"Tick":["Time.Posix"],"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"BuildLogWatch":["Basics.Int"],"BuildLogUnwatch":["Basics.Int"],"BuildRestart":["Basics.Int"],"GetLastBuilds":[],"GetOrganizations":[],"GetOrganizationBuilds":["String.String"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Debounce.Msg":{"args":[],"tags":{"NoOp":[],"Flush":["Maybe.Maybe Basics.Float"],"SendIfLengthNotChangedFrom":["Basics.Int"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}}}}})}});}(this));